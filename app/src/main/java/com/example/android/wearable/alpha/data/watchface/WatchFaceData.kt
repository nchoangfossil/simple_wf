...
// settings as well.
const val MINUTE_HAND_LENGTH_FRACTION_DEFAULT = 0.2783f
const val MINUTE_HAND_LENGTH_FRACTION_MINIMUM = 0.10000f
const val MINUTE_HAND_LENGTH_FRACTION_MAXIMUM = 0.30000f
...
data class WatchFaceData(
    ...
    val backGroundStyle: BackGroundStyle = BackGroundStyle.PIC1,
    ...
    val digitalStyle: DigitalStyle = DigitalStyle.SMALL
)
